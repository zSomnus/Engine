...
struct triangle
{
	vec3d p[3];	// 3 vertices for triangle
};
...
public:
	bool OnUserCreate() override
	{
		...
		float fFovRad = 1.0f / tanf(fFov * 0.5f / 180.0f * 3.14159f);	// Convert from degrees to radians
...
int main()
{
	...
	MyEngine demo;
	if (demo.ConstructConsole(GetSystemMetrics(SM_CXSCREEN) / 5, GetSystemMetrics(SM_CYSCREEN) / 5, 4, 4))
		demo.Start();
